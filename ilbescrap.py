...
class ilbe(object):
    ...
    def content_scraper(self,urls):
        csv_content_file = open(str("/home/mnkang89/jobdong/python_data/crawl_data/ilbe/")+"ilbe_cont_"+str(self.query)+str('.csv'), "w")
        csv_repl_file = open(str("/home/mnkang89/jobdong/python_data/crawl_data/ilbe/")+"ilbe_repl_"+str(self.query)+str('.csv'), "w")
        ...
        for i in range(jobs):
            ...
            try:
                ...
                cont_row=(number,subject,writer,time,content)
